...
pub mod client {
    ...
    ///
    /// # Returns
    /// * `Result<ImageClient<InterceptedService<Channel, impl Interceptor>>, Error>` - The connected client or connection error
    ///
    pub async fn new(
        api_key: &str,
    ) -> Result<ImageClient<InterceptedService<Channel, impl Interceptor>>, Error> {
