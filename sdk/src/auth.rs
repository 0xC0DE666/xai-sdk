...
pub mod client {
    ...
    ///
    /// # Returns
    /// * `Result<AuthClient<InterceptedService<Channel, impl Interceptor>>, Error>` - The connected client or connection error
    ///
    pub async fn new(
        api_key: &str,
    ) -> Result<AuthClient<InterceptedService<Channel, impl Interceptor>>, Error> {
