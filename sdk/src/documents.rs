...
pub mod client {
    ...
    ///
    /// # Returns
    /// * `Result<DocumentsClient, Error>` - The connected client or connection error
    ///
    ...
    ///
    /// # Returns
    /// * `DocumentsClient` - The connected client
    ...
    ///
    /// # Returns
    /// * `Result<DocumentsClient, Error>` - The connected, intercepted client or a connection error
    ///
    ...
    ///
    /// # Returns
    /// * `DocumentsClient` - The intercepted client
